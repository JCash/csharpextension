...
AOTBASE=${NUGET_DIR}/runtime.${OS}-${ARCH}.microsoft.dotnet.ilcompiler/8.0.0

PUBLISH_DIR=./NativeLibrary/bin/Release/net8.0/${OS}-${ARCH}/native
...
dotnet publish -c Release -r ${OS}-${ARCH} \
    -p:PublishAot=true \
    -p:NativeLib=Static \
